...
<div style="float: left" class="col-lg-10 span10 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá registrar la hoja de vida del participante.</li>
        ...
        <div id="rootwizard">
            ...
            <div class="tab-pane" id="tab3">
                ...
                <div class="row-fluid">
                    ...
                    <div class="col-lg-6 span6">
                        ...
                        <input type="file" class="span12"  name="fotoins" id="cam_fotoins" value="<?php print($Datos_Inscripcion['fotoins']);?>"/>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="col-lg-6 span6">
                ...
                <div class="row-fluid" id="docente_grado">
                    <div class="col-lg-6 span6">
            ...
            <div class="tab-pane" id="tab2">
                ...
                <div style="margin-top: 20px;" class="row-fluid">
                    <div class="col-lg-3 span3">
                        <label>Ingreso fijo? <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sí el responsable tiene otro tipo de ingreso."><i class="fa fa-question" ></i></span></label>
                            <label style="display:inline;margin-left:20px">SI
                             ...
                             <label style="display:inline;margin-left:30px">NO
                                <input type="radio"  onclick="ocultar_ingreso_fijo()"  name="ingresofijomensual" id="cam_ingresomensual2" value="0" <?php if($Datos_Inscripcion['ingresomensual']=='0'){echo 'checked';}?> />
                            </label>
                    </div>
                    ...
                    <div id="existe_otro_monto" class="col-lg-3 span3" style="display:none">
                        <label>¿Exite otro tipo de ingreso? <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sí el responsable tiene otro tipo de ingreso."><i class="fa fa-question" ></i></span></label>
                            <label style="display:inline;margin-left:20px">SI
                                <input type="radio"  onclick="desplegar_ingreso_otro()" name="otrotipoingreso" id="cam_otroingreso1" value="1" <?php if($Datos_Inscripcion['otroingreso']=='1'){echo 'checked';}?>/>
                            </label>
                             <label style="display:inline;margin-left:30px">NO
                                <input type="radio"  onclick="ocultar_ingreso_otro()"  name="otrotipoingreso" id="cam_otroingreso2" value="0" <?php if($Datos_Inscripcion['otroingreso']=='0'){echo 'checked';}?>/>
                            </label>
                    </div>
                    <div id="otro_monto" class="col-lg-3 span3" style="display:none">
                ...
                <div class="row-fluid">
                    <div id="sin_ingreso" class="col-lg-6 span6" style="display:none">
                ...
                <div class="row-fluid">
                    ...
                    <div id="tiempo_braile" class="col-lg-6 span6"  style="display:none">
...
function desplegar_ingreso_otro()
   ...
   {     
    ...
    {
        fecha=document.getElementById("cam_fechanacimientopar").value;
        edad=calcular_edad(fecha);
        if(edad<1)
        {
            Notifica_Error("La fecha ingresada es incorrecta o el participante muy joven para ser inscrito, por favor verifique la fecha de nacimiento.")
        }
    }
    ...
    function validar_vacio()
    {
        ...
        if(($('#cam_provieneinstitucion1').prop('checked')==false)&&($('#cam_provieneinstitucion2').prop('checked')==false)) {
                        Notifica_Error('Debe seleccionar si el participante proviene de alguna institución.');
                    ...
                    if(($('#cam_provieneinstitucion1').prop('checked')==true))
                    {
                        ...
                        Notifica_Error('Debe seleccionar la institución de la cual proviene el participante.');
                        $('#cam_tinstitucion_idinstitucion2').focus();
                        return false;
                        }
                         if(!$('#cam_gradoins').val()) {
                            Notifica_Error('Debe seleccionar el grado que cursaba el participante en la institución de la cual proviene.');
                            $('#cam_gradoins').focus();
                            return false;
                        }
                         if(!$('#cam_seccionins').val()) {
                            Notifica_Error('Debe seleccionar la sección del grado que cursaba el participante en la institución de la cual proviene.');
                            $('#cam_seccionins').focus();
                            return false;
                        }
                    }
                    if(!$('#cam_disponibilidadins').val()) {
                            Notifica_Error('Debe seleccionar la dispoiblidad del participante para asistir.');
        ...
        $('#rootwizard').bootstrapWizard({onNext: function(tab, navigation, index) 
            {
                if(index==1) 
                {
                    ...
                    if(!$('#cam_tdiagnostico_iddiagnostico').val()) {
                        Notifica_Error('Debe seleccionar el diagnostico del participante.');
