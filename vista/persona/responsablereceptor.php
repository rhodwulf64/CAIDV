...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form action="../controlador/control_responsablereceptor.php" method="POST" name="form_responsablereceptor">
        ...
        if($registrar)
        {
            echo '<a id="btn_registrar" class="btn btn-success" href="?vista=persona/registrar_responsablereceptor"><i class="icon-plus icon-white"></i> Registrar Responsable Receptor</a>';
        }
        ?>
