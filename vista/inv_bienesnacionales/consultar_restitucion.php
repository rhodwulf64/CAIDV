...
{
    $id=$_GET['id'];
    $loClasePrimera->set_Restitucion($id);
    $Datos_Restitucion = $loClasePrimera->consultar_restitucion_full();
}

$OnKey='';

if($Datos_Restitucion)
{
    $operacion='consultar_restitucion';
    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" id="f_formulario" name="f_formulario">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <input type="text" class="span12" maxlength="9"  name="txtNroDocumento" id="txtNroDocumento" onblur="BuscarRestitucionporCodigo(this.value)" <?php print($OnKey); ?> value="<?php print($Datos_Restitucion['nro_document']);?>" required/>
            ...
            <div class="col-lg-6 span6">
                ...
                <div class="span10 input-append date"  id="dp3" data-date="<?php print $fechaHoy; ?>"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    <input type="text" class="span12"  name="txtFechaLlegada" size="16" id="txtFechaLlegada" <?php print($OnKey); ?> required value="<?php print($Datos_Restitucion['fecha_mov']);?>" required/>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtResponsable" id="txtResponsable" class="span12" <?php print($OnKey); ?> required>
                    <option value="0">SELECCIONE UNA OPCION</option>
                    <?php print $loFuncGenerales->fnCombosPersonalActivos($Datos_Restitucion['id_per']); ?>
                </select>
            </div>
            <div class="col-lg-6 span6">
                ...
                <div class="span10 input-append date"  id="dp4" data-date="<?php print $fechaHoy; ?>"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    <input type="text" class="span12"  name="txtFechaRestitucion" size="16" id="txtFechaRestitucion" required value="<?php print($Datos_Restitucion['FechaAcordada']);?>" <?php print($OnKey); ?> required/>
                  <span class="add-on"><i class="icon-th"></i></span>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Ente Receptor<span class="asterisco">*</span>  <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sexo del docente."><i class="fa fa-question" ></i></span></label>
                <select name="txtEnte" id="txtEnte" class="span12" <?php print($OnKey); ?> required>
                    <option value="0">SELECCIONE UNA OPCION</option>
                    <?php print $loFuncGenerales->fnCombosEntesExternos($Datos_Restitucion['idFentefiador']); ?>
                </select>
            </div>
            <div class="col-lg-6 span6">
                ...
                <select name="txtResponsableEnte" id="txtResponsableEnte" class="span12" <?php print($OnKey); ?> required>
                    <option value="0">SELECCIONE UNA OPCION</option>
                    <?php print $loFuncGenerales->fnCombosResponsablesEnte($Datos_Restitucion['idFresponsableente']); ?>
                </select>
            </div>
        </div>
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtMotivo" id="txtMotivo" class="span12" <?php print($OnKey); ?> required>
                    ...
                    <?php 
                    print $loFuncGenerales->fnComboMotivosGeneral($Datos_Restitucion['id_motivo_mov'],"12");
                    ?>
                </select>
            </div>
           <div class="col-lg-6 span6">
                ...
                <textarea class="span12" maxlength="9"  name="txtObservacion" id="txtObservacion" <?php print($OnKey); ?>><?php print($Datos_Restitucion['observacion_mov']);?></textarea>
            </div>
        </div>
            <br>
             ...
             <table cellspacing="5" cellpadding="6%" width="" class="row-fluid" border="0" style="color:#808080">
                ...
                <tr>
                    <td style="padding:1px;"><input type="hidden" id="txtIDprestamo" name="txtIDprestamo" value=""><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtNroPresta" name="txtNroPresta"><?php print($Datos_Restitucion['nro_documentPrestamo']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtFechaPesta" name="txtFechaPesta"><?php print($Datos_Restitucion['FechoMovPrestamo']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtEnteBene" name="txtEnteBene"><?php print($Datos_Restitucion['RazonSocialEnte']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtRespEnte" name="txtRespEnte"><?php print($Datos_Restitucion['NombreApellidoRespEnte']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtRespCaidv" name="txtRespCaidv"><?php print($Datos_Restitucion['NombreApellidoResp']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtFechaAcorda" name="txtFechaAcorda"><?php print($Datos_Restitucion['FechaAcordaPrestamo']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtUsuario" name="txtUsuario"><?php print($Datos_Restitucion['NombreApellidoUser']);?></textarea></td>
                    <td style="padding:1px;"><textarea disabled style="resize: none;width:60px;font-size:8pt;margin:0px;" cols="5" rows="2" id="txtObservBN" name="txtObservBN"><?php print($Datos_Restitucion['observaPrestamo']);?></textarea></td>
...
var loF=document.f_formulario;
    ...
    {
        window.location.href="?vista=inv_bienesnacionales/registrar_restitucion&id="+id;
    }
