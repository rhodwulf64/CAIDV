...
<script>
 function buscar(id)
 {
  ...
  function descativar()
  {
    ...
    {
      if(confirm("¿Esta seguro que desea desactivar la restitución seleccionada?"))
      {
        var moviobjeto=document.getElementById("txtMoviObjeto").value;
        document.getElementById("txtAccion").value="desactivaRestitucion";
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if(Confi.lsExito==1)
                {
                    Notifica_Logro("Restitución desactivada con éxito.");   
                ...
                {
                    Notifica_Error("No se puede desactivar esta Restitución, inténtelo mas tarde.");
                }
  ...
  {
     if(confirm("¿Esta seguro que desea restaurar la restitución seleccionada?"))
    {
      document.getElementById("cam_iddocente").value=id;
  ...
  function CompruebaBN(moviobjeto,elementoBoton)
  {
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            {
                Notifica_Error("No se puede desactivar esta restitución porque ya tienen movimientos en sus registros.");
    ...
    <form action="../controlador/cConsultasAjaxBN.php" method="POST" id="form_recepcion" name="form_recepcion">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            ...
            <?php
                    ...
                    $loRestitucion=new clsRestitucion;
                    $laArticulosBN=$loRestitucion->listarRestitucion();
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Desactivar Prestación</h4>
              </div>
