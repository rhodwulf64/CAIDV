...
for($i=0;$i<count($laModulos);$i++) 
    {
        ...
        for ($j=0; $j <count($laServicios) ; $j++) //Se recorre un ciclo para poder extraer los datos de cada uno de los servicios que tiene prestado el modulo para poder constuir el menú
        {
...
<script>
 function buscar(id)
 {
  ...
  function descativar()
  {
    ...
    {
      if(confirm("¿Esta seguro que desea desactivar el prestamo seleccionado?"))
      {
        var moviobjeto=document.getElementById("txtMoviObjeto").value;
        document.getElementById("txtAccion").value="desactivaPrestamo";
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if(Confi.lsExito==1)
                {
                    Notifica_Logro("Prestamo desactivado con éxito.");                         
                }
                else    
                {
                    Notifica_Error("No se puede desactivar este Prestamo, inténtelo mas tarde.");
                }
  ...
  {
     if(confirm("¿Esta seguro que desea restaurar el prestamo seleccionado?"))
    {
      document.getElementById("cam_iddocente").value=id;
  ...
  function CompruebaBN(moviobjeto,elementoBoton)
  {
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            {
                Notifica_Error("No se puede desactivar esta Prestamo porque ya ha sido restituido el mismo.");
    ...
    <form action="../controlador/cConsultasAjaxBN.php" method="POST" id="form_recepcion" name="form_recepcion">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            ...
            <?php
                    ...
                    $laArticulosBN=$loPrestamo->listarPrestamo();
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Desactivar Prestamo</h4>
              </div>
              <div class="modal-body">
                   <div class="row">
                        <div class="col-lg-3 span3">
                            ...
                            <select name="txtMotivoAnulacion" class="form-control" id="txtMotivoAnulacion" value="">
