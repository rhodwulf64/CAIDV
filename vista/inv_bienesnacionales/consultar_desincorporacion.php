...
include('../clases/update2016/clase_desincorporacionbn.php');
$loClasePrimera = new clsDesincorporacion();

$fechaHoy=date("d-m-Y");

$id=(isset($_GET['id']))?$_GET['id']:"";
$loClasePrimera->set_NroDocumento($id);
$Datos_Consultados = $loClasePrimera->consultar_desincorporacion_bitacora();
$OnKey='';

if($Datos_Consultados)
{
    $operacion='editar_desincorporacion';
    $titulo   ='Consultar Desincorporación';
    $OnKey='readOnly';
}
else
{
    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" id="f_formulario" name="f_formulario">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Numero de Desincorporación <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Cédula de identidad del docente."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de Desincorporación<span class="asterisco">*</span><span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de nacimiento del docente."><i class="fa fa-question" ></i></span></label>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Responsable de la Desincorporación<span class="asterisco">*</span>  <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sexo del docente."><i class="fa fa-question" ></i></span></label>
                <select name="txtResponsable" <?php print($OnKey); ?> id="txtResponsable" class="span12" required>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtMotivo" id="txtMotivo" <?php print($OnKey); ?> class="span12" required>
                    <option value="0">SELECCIONE UN MOTIVO</option>
                    <?php 
                    print $loFuncGenerales->fnComboMotivosGeneral($Datos_Consultados['0']['id_motivo_mov'],"5");
                    ?>
                </select>
            </div>
           <div class="col-lg-6 span6">
                ...
                <textarea class="span12" maxlength="9" name="txtObservacion" id="txtObservacion" <?php print($OnKey); ?>><?php print $Datos_Consultados['0']['observacion_mov']; ?></textarea>
            </div>
        </div>
...
var loF=document.f_formulario;
    ...
    function BuscarDesincorporacionporCodigo(VarlorObj)
    {
        ...
        if (VarlorObj!="")
        {
            ...
            else
            {
                ...
                document.getElementById("txtAccion").value="BuscarDesincorporacionExiste";
    ...
    function GuardarCambios()
    {
        ...
        document.getElementById("txtAccion").value="incluirDesincorporacion";
        document.getElementById("txtExito").value="0";
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if(Confi.lsExito==1)
                {
                    ...
                    Notifica_Logro("Esta Desincorporación fué guardada con éxito.");
    ...
    function ValidarEnvioForm()
    {
        ...
        {
            Notifica_Error("Debe agregar al menos un Bien Nacional para realizar una desincorporación.");
            vInvalido=1;
        }
