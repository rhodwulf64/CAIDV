...
include('../clases/update2016/clase_asignacionbn.php');
$loClasePrimera = new clsAsignacion();

$fechaHoy=date("d-m-Y");

$id=(isset($_GET['id']))?$_GET['id']:"";
$loClasePrimera->set_NroDocumento($id);
$Datos_Consultados = $loClasePrimera->consultar_asignacion_bitacora();
$OnKey='';
if($Datos_Consultados)
{
    $operacion='consultar_asignacion';
    $titulo   ='Consultar Asignación';
    $OnKey='readOnly';
}
else
{
    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" id="f_formulario" name="f_formulario">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Numero de Asignación <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Cédula de identidad del docente."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de Asignación<span class="asterisco">*</span><span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de nacimiento del docente."><i class="fa fa-question" ></i></span></label>
                <div class="span10 input-append date"  id="dp3" data-date="<?php print $fechaHoy; ?>"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    <input type="text" class="span12"  name="txtFechaLlegada" size="16" id="txtFechaLlegada" <?php print($OnKey); ?> value="<?php print($Datos_Consultados['0']['fecha_mov']);?>" required/>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Responsable de la Asignación<span class="asterisco">*</span>  <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sexo del docente."><i class="fa fa-question" ></i></span></label>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtMotivo" id="txtMotivo" <?php print($OnKey); ?> class="span12" required>
                    ...
                    <?php 
                    print $loFuncGenerales->fnComboMotivosGeneral($Datos_Consultados['0']['id_motivo_mov'],"3");
                    ?>
                </select>
            </div>
           <div class="col-lg-6 span6">
...
<!-- ******************************************* Detalle del bien nacional *************************************************-->
    ...
    <tr>
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=inv_bienesnacionales/ver_asignacion'">
        </div>
...
var loF=document.f_formulario;
    ...
    function BuscarAsignacionporCodigo(VarlorObj)
    {
        ...
        if (VarlorObj!="")
        {
            ...
            else
            {
                ...
                document.getElementById("txtAccion").value="BuscarAsignacionExiste";
    ...
    function GuardarCambios()
    {
        if (ValidarEnvioForm())
        {
            ...
            for(liY=1;liY<=liFila;liY++)
            {
                ...
                document.getElementById("txtAccion").value="incluirAsignacion";
                document.getElementById("txtExito").value="0";
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        if(Confi.lsExito==1)
                        {
                              ...
                              Notifica_Logro("Esta Asignación fué guardada con éxito.");
                            ...
                            setTimeout(function()
                            {
                                if (confirm("Desea registrar una nueva Asignación?"))
                                {
                                    fpLimpiarForm();
                                }
                                else
                        ...
                        {
                            Notifica_Error("Esta Asignación no se pudo guardar, verifique los datos ingresados.");  
                        }
    ...
    function ValidarEnvioForm()
    {
        ...
        {
            Notifica_Error("Debe agregar al menos un Bien Nacional para realizar una asignación.");
            vInvalido=1;
        }
