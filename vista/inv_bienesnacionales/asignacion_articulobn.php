...
//$loClasePrimera->set_Docente($id);
//$Datos_Consultados = $loClasePrimera->consultar_docente_bitacora();
$OnKey='';
if($Datos_Consultados)
{
    $operacion='consultar_asignacion';
    $titulo   ='Consultar asignacion';
    $OnKey='readOnly';
}
else
{
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtMotivo" id="txtMotivo" class="span12" required>
                    ...
                    <?php
                    print $loFuncGenerales->fnComboMotivosGeneral($selectMotivo,"3");
                    ?>
                </select>
            </div>
           <div class="col-lg-6 span6">
...
var loF=document.f_formulario;
    ...
    {
        window.location.href="?vista=inv_bienesnacionales/consultar_asignacion&id="+id;
    }
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        if(Confi.lsExito==1)
                        {
                              ...
                              Notifica_Logro("Esta Asignación fue guardada con éxito.");
