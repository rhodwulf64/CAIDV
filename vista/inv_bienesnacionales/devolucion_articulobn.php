...
else
{
    ...
    $titulo   ='Registrar Nueva Devolución de Bienes Nacionales';
}
...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" id="f_formulario" name="f_formulario">
        ...
        <div class="row-fluid">
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de la Devolución<span class="asterisco">*</span><span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de la Devolución."><i class="fa fa-question" ></i></span></label>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Responsable de la Devolución<span class="asterisco">*</span>  <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Responsable de la Devolución."><i class="fa fa-question" ></i></span></label>
        ...
        <div class="row-fluid">
         ...
         <h4>Devolución: Selección de Bienes Nacionales</h4>
         </legend>
            <div class="row-fluid">
