  ...
  function descativar()
  {
    if (document.getElementById("txtMotivoAnulacion").value!="0")
    {
      if(confirm("¿Esta seguro que desea desactivar el docente seleccionado?"))
      {
        ...
        document.getElementById("txtAccion").value="desactivaDevolucion";
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if(Confi.lsExito==1)
                {
                    Notifica_Logro("Devolución desactivada con éxito.");                         
                }
                else    
                {
...
<div style="float: left" class="col-lg-10 span10 pull-left">
    ...
    <form action="../controlador/cConsultasAjaxBN.php" method="POST" id="form_recepcion" name="form_recepcion">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            <thead>
                <th>N° Dev.</th><th>Fecha Dev.</th><th>Fecha de Registro</th><th>Asignatura</th><th>Responsable Asignatura</th><th>Responsable Dev.</th><th>Usuario</th><th>Motivo</th><th>Observación</th><th>Acción</th>
            </thead>
            <tbody>
            <?php
                    require_once('../clases/update2016/clase_devolucionbn.php');
                    $loDevoluciones=new clsDevolucion;
                    $laArticulosBN=$loDevoluciones->listarDevoluciones();
