...
include('../clases/update2016/clase_prestamobn.php');
$loClasePrimera = new clsPrestamo();

$fechaHoy=date("d-m-Y");

$id=(isset($_GET['id']))?$_GET['id']:"";
$loClasePrimera->set_NroDocumento($id);
$Datos_Consultados = $loClasePrimera->consultar_prestamo_bitacora();
$OnKey='';

if($Datos_Consultados)
{
    $operacion='consultar_prestamo';
...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá prestar bienes nacionales a los diferentes entes externos.</li>
    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" id="f_formulario" name="f_formulario">
        <legend class="label label-info"><h4>Prestamo: Datos de la Operación</h4></legend>
        <input type="hidden" value="Prestamos" name="txtSegmento" id="txtSegmento"/>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Numero de Prestamo <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Cédula de identidad del docente."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de Prestamo<span class="asterisco">*</span><span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de nacimiento del docente."><i class="fa fa-question" ></i></span></label>
                <div class="span10 input-append date"  id="dp3" data-date="<?php print $fechaHoy; ?>"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    <input type="text" class="span12" <?php print($OnKey); ?> name="txtFechaLlegada" size="16" id="txtFechaLlegada" required value="<?php print($Datos_Consultados['0']['fecha_mov']);?>" required/>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Responsable de la Prestamo<span class="asterisco">*</span>  <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Sexo del docente."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de Devolución Acordada<span class="asterisco">*</span><span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de Devolución Acordada."><i class="fa fa-question" ></i></span></label>
                <div class="span10 input-append date"  id="dp4" data-date="<?php print $fechaHoy; ?>"  data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    <input type="text" class="span12" <?php print($OnKey); ?> name="txtFechaAcordada" size="16" id="txtFechaAcordada" required value="<?php print($Datos_Consultados['0']['FechaAcordada']);?>" required/>
                  <span class="add-on"><i class="icon-th"></i></span>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <select name="txtEnte" id="txtEnte" <?php print($OnKey); ?> class="span12" required>
                    <option value="0">SELECCIONE UNA OPCION</option>
                    <?php print $loFuncGenerales->fnCombosEntesExternos($Datos_Consultados['0']['idFentefiador']); ?>
                </select>
            </div>
            <div class="col-lg-6 span6">
                ...
                <select name="txtResponsableEnte" id="txtResponsableEnte" <?php print($OnKey); ?> class="span12" required>
                    <option value="0">SELECCIONE UNA OPCION</option>
                    <?php print $loFuncGenerales->fnCombosResponsablesEnte($Datos_Consultados['0']['idFresponsableente']); ?>
                </select>
            </div>
        </div>
        <div class="row-fluid">
...
var loF=document.f_formulario;
    ...
    function BuscarPrestamoporCodigo(VarlorObj)
    {
        ...
        if (VarlorObj!="")
        {
            ...
            else
            {
                ...
                document.getElementById("txtAccion").value="BuscarPrestamoExiste";
    ...
    function GuardarCambios()
    {
        ...
        document.getElementById("txtAccion").value="incluirPrestamo";
        document.getElementById("txtExito").value="0";
    ...
    function ValidarEnvioForm()
    {
        ...
        {
            Notifica_Error("Seleccione un Ente externo.");
            $("#txtEnte").focus();
            vInvalido=1;
        }
        ...
        {
            Notifica_Error("Debe agregar al menos un Bien Nacional para realizar un prestamo.");
            vInvalido=1;
        }
