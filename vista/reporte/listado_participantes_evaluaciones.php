...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3>Participante por evaluación</h3>
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            ...
            <?php
                    ...
                    for($i=0;$i<count($laParticipantes);$i++)
                    {
                        ...
                        echo '<td><a class="btn btn-info" href="?vista=reporte/consultar_evaluaciones&idparticipante='.$laParticipantes[$i][0].'" ><i class="fa fa-sign-in"></i></a></td>';
                        echo '</tr>';
                    }
                ?>
                </tbody>
