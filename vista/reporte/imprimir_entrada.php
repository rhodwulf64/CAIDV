...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3>Recepción de Consumibles</h3>
    ...
    <form  name="form_requisicion">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            ...
            <?php
                    ...
                    $larequisicions=$lobjrequisicion->consultar_requisicion_imprimir();
                    for($i=0;$i<count($larequisicions);$i++)
                    {
                        ...
                        echo '<td><a class="btn btn-success" href="../reporte/imprimir_entrada.php?id='.$larequisicions[$i][0].'" target="_blank"><i class="fa fa-file-text"></i></a></td>';                       
                        echo '</tr>';
                    }
                ?>
                </tbody>
