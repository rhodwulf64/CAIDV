...
$loPrincipal = NEW clsTipodebien();
$id=(isset($_GET['id']))?$_GET['id']:"";
$loPrincipal->set_IDprincipal($id);
$Datos_Instrumento = $loPrincipal->consultar_tipodebien_especifico();
if($Datos_Instrumento)
{
    $operacion='editar_tipodebien';
    $titulo   ='Editar Tipo de Bien Nacional';
}
else
{
    $operacion='registrar_tipodebien';
    $titulo   ='Registrar Tipo de Bien Nacional';
}
?>
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
     <ul>
    <li>En este formulario podrá registar un nuevo Tipo de Bien Nacional.
    ...
    <form class="formulario" action="../controlador/control_tipodebien.php" method="POST" name="form_instrumento">
        <input type="hidden" value="<?php print($operacion);?>" name="operacion" />
        <input type="hidden" value="<?php print($Datos_Instrumento['id_tbien']);?>" name="idinstrumento" />
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Serie <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Nombre del instrumento."><i class="fa fa-question" ></i></span></label>
                <input type="text" class="span12"  name="txtCodTipoBN" id="txtCodTipoBN" maxlength="30" value="<?php print($Datos_Instrumento['cod_tbien']);?>" required/>
            </div>       
        </div>
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <input type="text" class="span12"  name="txtDescripcion" id="txtDescripcion" maxlength="50" value="<?php print($Datos_Instrumento['des_tbien']);?>" required/>
            </div>    
            <div class="col-lg-6 span6">
                <label>Categoría <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Asignatura para la cual se usará el instrumento."><i class="fa fa-question" ></i></span></label>
                
               <select name="txtSegundoValor" id="txtSegundoValor" class="span12" required>
                    <option value="">SELECCIONE UNA CATEGORÍA</option>
                    <?php 
                    print $loFuncGenerales->fnComboCategoriaBN($Datos_Instrumento['id_categoria']);
                    ?>
                </select>
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=archivo/tipodebien';">
        </div>
    </form>
</div>
...
$(function()
{
$("#txtCodTipoBN").lemez_aceptar("todo","btn_enviar");
$("#txtDescripcion").lemez_aceptar("texto","btn_enviar");
});
