...
$loPrincipal = NEW clsEntereceptor();
$id=(isset($_GET['id']))?$_GET['id']:"";
$loPrincipal->set_IDprincipal($id);
$Datos_Instrumento = $loPrincipal->consultar_entereceptor_especifico();
if($Datos_Instrumento)
{
    $operacion='editar_entereceptor';
    $titulo   ='Editar Ente Externo';
}
else
{
    $operacion='registrar_entereceptor';
    $titulo   ='Registrar Ente Externo';
}
?>
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
     <ul>
    <li>En este formulario podrá registar el Ente Externo que será aplicado en la evaluación.
    ...
    <form class="formulario" action="../controlador/control_entereceptor.php" method="POST" name="form_instrumento">
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=archivo/entereceptor';">
        </div>
    </form>
</div>
...
$(function()
{
$("#txtRazonSocial").lemez_aceptar("texto_numero","btn_enviar");
$("#txtRif").lemez_aceptar("rifpublico","btn_enviar");
$("#txtTelefono").lemez_aceptar("telefono","btn_enviar");
});
