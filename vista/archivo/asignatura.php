...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form action="../controlador/control_asignatura.php" method="POST" name="form_asignatura">
        ...
        if($registrar)
        {
            echo '<a id="btn_registrar" class="btn btn-success" href="?vista=archivo/registrar_asignatura"><i class="icon-plus icon-white"></i> Registrar</a>';
        }
        ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Desactivar asignatura</h4>
