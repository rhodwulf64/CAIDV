...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá registrar el aula donde se le dictará curso al participante .</li>
    ...
    <form class="formulario" action="../controlador/control_aula.php" method="POST" name="form_aula">
        ...
        <div class="botonera">
            <input type="submit" data-step="4" data-intro='Haga clic en <button class="btn btn-success">Aceptar</button> para guardar el aula ingresada' data-position="top" class="btn btn-success" name="btn_enviar" id="btn_enviar" value="Aceptar">
