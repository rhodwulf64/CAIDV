...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
     <ul>
    <li>En este formulario podrá registar el instrumento que será aplicado en la evaluación.
    ...
    <form class="formulario" action="../controlador/control_instrumento.php" method="POST" name="form_instrumento">
        ...
        <div class="row-fluid">
            ...
            <div class="col-lg-6 span6">
                ...
                <select class="span12" name="tasignatura_idasignatura" id="cam_tasignatura_idasignatura" required>
                    ...
                    { 
                        echo '<option value="'.$laAsignaturas[$i][0].'">'.$laAsignaturas[$i][1].'</option>';
                    }
                    ?>
                </select>
            </div>         
        ...
        <div class="row-fluid">            
            <h4>Criterio de evaluacións a usar</h4>            
            ...
            <div class="col-lg-12 span12" id="items_usar" >
                    ...
                    <tbody id="tabla_items">
                        <tr>
                            <td style="text-align:center">
                                <select name="item[]" id="cam_item0" onchange="item_repetido(this);">
                                    <option value="">-</option>
                                    <?php
                            ...
                            <td style="text-align:center">
                                <select name="espacio[]" id="cam_espacio0">
                                    <option value="">-</option>
                                    <option value="mitad">Media fila</option>
                                    <option value="completo">Toda la fila</option>
                                </select>
                            </td>
                            <td style="text-align:center">
                ...
                <input type="hidden" value="0" name="contador" id="cam_contador">
            </div>
        </div>
        <div class="row-fluid">
            <div class="botonera">
