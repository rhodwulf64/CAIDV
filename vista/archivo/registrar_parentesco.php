...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá registrar el parentesco del familiar hacia el participante.</li>
    ...
    <form class="formulario" action="../controlador/control_parentesco.php" method="POST" name="form_parentesco">
        <input type="hidden" value="registrar_parentesco" name="operacion" />
        ...
        <input type="text" name="descripcionpar" id="cam_descripcionpar"onchange="validar_nombre();" required/>
        <div class="botonera">
