...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3>Registrar Condición visual</h3>
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá registrar la condición visual del participante, docente y fammiliar.</li>
    ...
    <form class="formulario" action="../controlador/control_diagnostico.php" method="POST" name="form_diagnostico">
        <input type="hidden" value="registrar_diagnostico" name="operacion" />
        ...
        <input type="text" name="descripciondia" id="cam_descripciondia" onchange="validar_nombre();" required/>
        <div class="botonera">
