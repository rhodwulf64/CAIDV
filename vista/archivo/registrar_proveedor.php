...
$loProveedor->set_Proveedor($id);
$Datos_Instrumento = $loProveedor->consultar_proveedor_especifico();
...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form class="formulario" action="../controlador/control_proveedor.php" method="POST" name="form_instrumento">
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=archivo/proveedor';">
        </div>
    </form>
</div>
...
$("#txtRif").lemez_aceptar("rif","btn_enviar");
});
