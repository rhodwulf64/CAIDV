...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3><?php print($titulo); ?></h3>
     <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá registrar el grupo de edad que pertenecerá el participante.</li>
    ...
    <form class="formulario" action="../controlador/control_grupo.php" method="POST" name="form_grupo">
        ...
        <div class="row-fluid">
            ...
            <div class="col-lg-6 span6">
                ...
                <input type="text" class="span12" maxlength="3" name="edadmax" onchange="validar_edad();" id="cam_edadmax" required value="<?php print($Datos_Grupo['edadmax']);?>"/>
            </div>
        </div>
        <div class="botonera">
            <input type="submit" class="btn btn-success" onclick="return validar_edad();" name="btn_enviar" id="btn_enviar" value="ACEPTAR">
