...
$Datos_Valor_Item = $lobjItem->consultar_item_valor();
...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
     <ul>
    <li>En este formulario podrá consultar y editar el criterio de evaluación que se utilizará en el instrumento para aplicar la evaluación.
    ...
    <form class="formulario" action="../controlador/control_item.php" method="POST" name="form_item">
        ...
        <div class="row-fluid">
            ...
            <div class="col-lg-6 span6">
                ...
                <textarea class="span12"  name="descripcionite" id="cam_descripcionite" value="" required><?php print($Datos_Item['descripcionite']);?></textarea>
            </div>
        </div>
        <div class="row-fluid">        
            <div class="col-lg-6 span6">
                ...
                <select class="span12" name="tipoite" id="cam_tipoite" required>
                    <option value="">-</option>
                    <option value="text" <?php if($Datos_Item['tipoite']=='Campo de texto'){echo 'selected';}?>>Campo de texto</option>
                    <option value="textarea" <?php if($Datos_Item['tipoite']=='Area de texto'){echo 'selected';}?>>Area de texto</option>
                    <option value="select" <?php if($Datos_Item['tipoite']=='Lista de selección'){echo 'selected';}?>>Lista de selección</option>
                    <option value="radio" <?php if($Datos_Item['tipoite']=='Circulo Selección simple'){echo 'selected';}?>>Circulo Selección simple</option>
                    <option value="checkbox" <?php if($Datos_Item['tipoite']=='Cuadro Selección Multiple'){echo 'selected';}?>>Cuadro Selección Multiple</option>

                </select>
            </div>
            <div class="col-lg-6 span6" id="caja_cantidad" style="<?php if(!$Datos_Valor_Item){ echo 'display:none';}?>">
                ...
                <select class="span12" name="cantidad" id="cam_cantidad">
                    ...
                    <?php
                        for ($i=1; $i <=10 ; $i++)
                        { 
                            $selected=(count($Datos_Valor_Item)==$i)?'selected':'';
        ...
        <div class="row-fluid">            
            <div class="col-lg-6 span6" id="caja_valores"  style="<?php if(!$Datos_Valor_Item){ echo 'display:none';}?>">
                ...
                <table>
                    <tbody id="tabla_valores">
                        <?php
                            if(count($Datos_Valor_Item))
                            {
                                for($i=0;$i<count($Datos_Valor_Item);$i++)
                                {
                                    echo '
                                    <tr>
                                        <td><b>'.($i+1).'</b></td>
                                        <td><input name="valor[]" type="text" value="'.$Datos_Valor_Item[$i][1].'" /></td>
                                    </tr>
                                    ';
                                }
                            }
        ...
        <div class="row-fluid">
            <div class="botonera">
                <button type="button" class="btn btn-info" name="btn_visualizar" id="btn_visualizar" value="VISUALIZAR"><i class="fa fa-eye"></i> Visualizar</button>      
            </div>
        </div>
        <div class="row-fluid">
            <h4>Visualizador</h4>            
