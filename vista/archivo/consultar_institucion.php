...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            <li>En este formulario podrá consultar y editar la institución en el sistema.</li>
    ...
    <form class="formulario" action="../controlador/control_institucion.php" method="POST" name="form_institucion">
        ...
        <div class="botonera">
            <input type="submit" data-step="5" data-intro='Haga clic en <button class="btn btn-success">Guardar</button> para guardar la institución ingresada' data-position="top" class="btn btn-success" name="btn_enviar" id="btn_enviar" value="Guardar">
