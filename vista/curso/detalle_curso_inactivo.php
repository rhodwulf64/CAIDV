...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form action="../controlador/control_inscripcion_curso.php" method="POST" name="form_lapso">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro"> 
            <thead>
                <th>Foto</th><th>Cédula</th><th>Apellidos</th><th>Nombre</th><th></th>
            </thead>
            <tbody>
            <?php
                    if($idcurso)
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=curso/cursos_inactivos';">
        </div>
    </form>
</div>
