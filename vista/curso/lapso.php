...
<script>
 function buscar(id)
 {
  ...
  {
     if(confirm("¿Esta seguro que desea restaurar el lapso?"))
    {
      document.getElementById("cam_idlapso").value=id;
      document.getElementById("cam_operacion").value='restaurar_lapso';
      document.form_lapso.submit();
    }
  }
</script>
...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <div class="alert alert-info">
        <ul>
            En este módulo podrá registrar, consultar, editar, desactivar, activar, aperturar, programar y cerrar lapso académicos.  
        </ul>
    </div>
    <form action="../controlador/control_lapso.php" method="POST" name="form_lapso">
        ...
        <a class="btn btn-success" id="btn_registrar" href="?vista=curso/registrar_lapso"><i class="icon-plus icon-white"></i> Registrar lapso</a>
              ...
              <div class="modal-body">
                   <div class="row">
                        <div class="col-lg-3 span3">
                            <label>Motivo <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Motivo por la cual desea desactivar la asignatura."><i class="fa fa-question" ></i></span></label>
