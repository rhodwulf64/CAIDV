...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3><?php print($titulo); ?></h3>
     <div class="alert alert-info">
        <ul>
            <li>En este formuario podrás registrar la noticia del home page o pagina de inicio..</li>
    ...
    <form class="formulario" enctype="multipart/form-data" action="../controlador/control_noticia.php" method="POST" name="form_noticia">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                ...
                <input type="file" class="span12"  name="imagennot" id="cam_imagennot"  value="<?php print($Datos_Noticia['imagennot']);?>" required/>
            </div>
            <div class="col-lg-6 span6">
