...
if($Datos_Participante)
{
    ...
    $titulo   ='Consultar hoja de vida del participante';
}
else
{
...
?>
    ...
    <form class="formulario"  action="../controlador/control_preinscripcion.php" method="POST" name="form_participante" id="form_participante" enctype="multipart/form-data">
        <input type="hidden" value="registrar_preinscripcion" name="operacion" />
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="col-lg-6 span6">
                            ...
                            <input type="text" class="span12" maxlength="8" <?php if($Datos_Participante['nacionalidadpar']=="N"){print('readonly');}?> onblur="validar_nombre();"  name="cedulapar" id="cam_cedulapar" value="<?php print($Datos_Participante['cedulapar']);?>" required/>
                    ...
                    <br>
                    <div class="botonera">
                        <input type="submit" class="btn btn-success" name="btn_enviar" id="btn_enviar" value="Registrar">
                    </div>
                </div>
            <!--FIN PARTICIPANTE-->
            </div>
