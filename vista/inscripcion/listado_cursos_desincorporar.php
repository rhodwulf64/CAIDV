...
<div style="float: left" class="col-lg-8 span8 pull-left">
    <h3>Desincorporar masivamente por curso</h3>
    <div class="alert alert-info">
        <ul>
            En este módulo podrá seleccionar el curso en donde quiera desincorporar participante.
        </ul>
    </div>
    <form action="../controlador/control_curso.php" method="POST" name="form_lapso">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro">
            ...
            <?php
                    ...
                    $laCursos=$lobjCurso->consultar_cursos_inscritos();
                    for($i=0;$i<count($laCursos);$i++)
                    {
                        ...
                        echo '<td><a class="btn btn-warning" title="Inscribir" href="?vista=inscripcion/desincorporar_participantes&id='.$laCursos[$i][0].'"><i class="icon-edit icon-white"></i></a></td>';
                        echo '</tr>';
                    }
                ?>
                </tbody>
