...
<div style="float: left" class="col-lg-8 span8 pull-left">
    ...
    <form action="../controlador/control_inscripcion_curso.php" method="POST" name="form_lapso">
        ...
        <table class="table table-striped table-hover table-bordered bootstrap-datatable datatable dataTable" id="filtro"> 
            <thead>
                <th>Foto</th><th>Cedula</th><th>Apellidos</th><th>Nombre</th><th>Inscribir</th>
            </thead>
            <tbody>
            <?php
                    if($idcurso)
                    {
                        ...
                        for($i=0;$i<count($laParticipantes);$i++)
                        {
                            ...
                            echo '<tr>';
                            echo '<td><img style="width:52px;height:52px;" src="../media/img/participantes/'.$laParticipantes[$i][4].'"/></td>';
                            ...
                            echo '<td style="padding-top:20px"><input type="checkbox" style=" -ms-transform: scale(2);-moz-transform: scale(2);-webkit-transform: scale(2);-o-transform: scale(2);" name="participante_inscribir[]" value="'.$laParticipantes[$i][5].'" '.$checked.'/></td>';
                            echo '</tr>';
                                $checked="";
        ...
        <div class="botonera">
            ...
            <input type="button" class="btn btn-danger" name="btn_regresar" id="btn_regresar" value="Regresar" onclick="window.location.href='?vista=curso/cursos_ofertados';">
        </div>
    </form>
</div>
