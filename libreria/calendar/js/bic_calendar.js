...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="fa fa-arrow-right"><i class="glyphicon glyphicon-arrow-right" ></i></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="fa fa-arrow-left"><i class="glyphicon glyphicon-arrow-left" ></i></a></td>');
            //event
            ...
            var nextYearButton = $('<td><a href="#" class="fa fa-arrow-right"><i class="glyphicon glyphicon-arrow-right" ></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="fa fa-arrow-left"><i class="glyphicon glyphicon-arrow-left" ></i></a></td>');
            //event
        ...
        function markEvents(month, year) {
            ...
            var d = new Date();
            var f=d.getUTCDate()+'_'+(d.getUTCMonth()+1)+'_'+d.getFullYear();
                var loopDayTd = $('#' + calendarId + '_' +f);
                loopDayTd.css('border', 'solid 3px #ccc');
