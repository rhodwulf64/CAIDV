...
class clsDesincorConsul Extends ModeloConect{
	...
	function Consultar_desincorporacion(){
		...
		FROM movimientobn as mov,personal as per,usuario as user,motivobn as mot_mov,tipomovibn as tipo_mov,periodo as peri
