...
class clsRecepcionConsul Extends ModeloConect{
	...
	function Consultar_Recepcion(){
		...
		FROM movimientobn as mov INNER JOIN personal as per INNER JOIN usuario as user INNER JOIN motivobn as mot_mov INNER JOIN tipomovibn as tipo_mov INNER JOIN proveedor as prov INNER JOIN periodo as peri INNER JOIN departamento as depart
