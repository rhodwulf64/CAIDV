...
class clsDevolucionConsul Extends ModeloConect{
	...
	function Consultar_devolucion(){
		...
		FROM movimientobn as mov,personal as per, personal as resp,usuario as user,motivobn as mot_mov,tipomovibn as tipo_mov,periodo as peri,departamento as depart
