<?php
   ...
   $resultados=$historial->historial_empresa($cod);
   ...
   $lobjPdf->Ln(10);
	$lobjPdf->Cell(50,6,utf8_decode(""),0,1,"C");		
	 ...
	 $lobjPdf->Cell(0,6,utf8_decode("Historial de Actividades Realizadas por ".$resultados[0][0]),0,1,"C");	
	 $lobjPdf->Ln(6);
   ...
   $lobjPdf->Ln(10);
		...
		$lobjPdf->Cell(0,6,utf8_decode("No ha Realizado Actividades"),0,1,"C");	
	}else{
		...
		$lobjPdf->Cell(40,6,utf8_decode('Hora'),1,0,"C");
		$lobjPdf->Cell(30,6,utf8_decode('Estatus'),1,1,"C");
		...
		for ($i=0; $i < count($resultados) ; $i++) { 
			...
			$lobjPdf->Cell(40,6,utf8_decode($resultados[$i][6].' a '.$resultados[$i][7]),1,0,"C");
			$lobjPdf->Cell(30,6,utf8_decode($resultados[$i][9]),1,1,"C");
		}
